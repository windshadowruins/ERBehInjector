...
def open_ui():
    ...
    state_machine_combo = ttk.Combobox(root, values=["AddBlendSpeak_SM", "AddDamageGuard_SM", "AddDamageLv0_SM", "AddDamage_SM", "AddTalkHead_SM", "AttackArrowLeft_Lower_SM", "AttackArrowLeft_SM", "AttackArrowLeft_Upper_SM", "AttackArrowRight_Lower_SM", "AttackArrowRight_SM", "AttackArrowRight_Upper_SM", "AttackBoth_SM", "AttackCrossbowBothLeft_Lower_SM", "AttackCrossbowBothLeft_Upper_SM", "AttackCrossbowBothRight_Upper_SM", "AttackCrossbowLeft_Lower_SM", "AttackCrossbowLeft_Upper_SM", "AttackCrossbowRight_Lower_SM", "AttackCrossbowRight_Upper_SM", "AttackDualWield_SM", "AttackLeft_SM", "AttackRight_SM", "Attack_SM", "Bonfire_SM", "ChainRecoverState_SM", "DamageBlend_SM", "DamageDirBlend_SM", "Damage_NoThrowDef_SM", "Damage_SM", "Death_SM", "DrawStanceNoSync_Lower_SM", "DrawStanceNoSync_Upper_SM", "DrawStanceRight_Lower_SM", "DrawStanceRight_Upper_SM", "Evasion_SM", "EventGesture_SM", "EventHalfBlend_SM", "EventHalfBlend_Upper_SM", "EventTurn_SM", "Event_SM", "Fall_SM", "Gesture_SM", "Gesture_Upper_SM", "GuardDamage_SM", "Guard_SM", "Guard_Upper_SM", "HalfBlendNoSync_SM", "HalfBlendNoSync_Upper_SM", "HandChange_SM", "HandChange_Upper_SM", "Item_SM", "Item_Upper_SM", "LadderItemLeft_SM", "LadderItemRight_SM", "LadderItem_SM", "Ladder_SM", "Lower_SM", "Magic_Lower_SM", "Magic_Upper_SM", "Master_SM", "NormalItem_SM", "NormalItem_Upper_SM", "QuickItemThrowKnife_SM", "QuickItemThrowKnife_Upper_SM", "QuickItemWeaponEnchant_SM", "QuickItemWeaponEnchant_Upper_SM", "QuickItem_SM", "QuickItem_Upper_SM", "QuickTurn_SM", "QuickTurn_Upper_SM", "RideEvent_SM", "RideHandChange_SM", "RideItem_SM", "RideMagic_SM", "RideWeaponChange_SM", "Ride_NoThrow_SM", "Ride_SA_Add_SM", "SAMagic_SM", "StealthAttackArrow_SM", "StealthAttackArrow_Upper_SM", "StealthAttackCrossbowBothLeft_Lower_SM", "StealthAttackCrossbowBothLeft_Upper_SM", "StealthAttackCrossbowBothRight_Lower_SM", "StealthAttackCrossbowBothRight_Upper_SM", "StealthAttackCrossbowLeft_Lower_SM", "StealthAttackCrossbowLeft_Upper_SM", "StealthAttackCrossbowRight_Lower_SM", "StealthAttackCrossbowRight_Upper_SM", "StealthHandChange_SM", "StealthHandChange_Upper_SM", "StealthItem_SM", "StealthItem_Upper_SM", "StealthStopHalfBlend_SM", "StealthStopHalfBlend_Upper_SM", "StealthStop_SM", "StealthWeaponChange_SM", "StealthWeaponChange_Upper_SM", "Stealth_SM", "StopHalfBlend_SM", "Stop_SM", "SwordArtsCharge_SM", "SwordArtsHalf_SM", "SwordArtsHalf_Upper_SM", "SwordArtsLoop_SM", "SwordArtsOneShotCombo_SM", "SwordArtsOneShotShield_SM", "SwordArtsStance_SM", "SwordArtsTransition_SM", "SwordArts_SM", "TalkDamage_SM", "TalkEvent_SM", "TalkLoop_SM", "TalkOneShot_SM", "TalkSpecialIdle_SM", "TelescopeTower_SM", "Throw_SM", "Upper_SM", "WeaponChange_SM", "WeaponChange_Upper_SM"], font=("Arial", 12), state="readonly")
